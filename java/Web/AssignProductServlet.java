...
@WebServlet(name = "AssignProduct", urlPatterns = {"/production/AssignProduct"})
public class AssignProductServlet extends BaseServlet {
    ProductionDAO pdao;
    OrderDAO odao;
    
    public AssignProductServlet()
    {
           ...
           throws ServletException, IOException 
   {
        ...
        try {
            ...
            Logger.getLogger(AssignProductServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        try
        {
        odao.updateorderline(oid, "Processing");
