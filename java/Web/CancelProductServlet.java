 ...
 * @author Sean
 */
@WebServlet(name = "CancelProduct", urlPatterns = {"/production/CancelProduct"})
public class CancelProductServlet extends BaseServlet {
    ProductionDAO pdao;
    OrderDAO odao;
    
    public CancelProductServlet()
    {
           ...
           throws ServletException, IOException 
   {
        ...
        try
        {
        odao.updateorderline(oid, "Cancelled");
